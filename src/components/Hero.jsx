  ...
  return (
    <section className="hero" id="top">
      <div className="wrap">
        ...
        <p className="eyebrow">Remote control for Claude Code and Codex</p>
        ...
        <p className="lead">
          ...
          Claude Code and Codex, routing every risky action to your phone first. You
          decide, not a popup you clicked past.
        </p>
